...
public class TerrainGenerator : MonoBehaviour
{
	...
	private List<float> CalculateBiomeNoise(List<Vector3Int> biomeCenters, Vector2Int mapSeedOffset)
	{
		...
		return biomeCenters.Select(center => NoiseGenerator.OctavePerlin(center.x, center.y, biomeNoiseSettings)).ToList();
	}
...
public class BiomeGeneratorSelection
{
	...
	public BiomeGeneratorSelection(BiomeGenerator sourceBiomeGenerator, int? terrainSurfaceNoise = null)
	{
		this.biomeGenerator = sourceBiomeGenerator;
