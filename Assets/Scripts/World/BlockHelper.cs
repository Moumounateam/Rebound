...
public static class BlockHelper
{
	...
	public static Vector2[] FaceUVs(Direction direction, BlockType blockType)
	{
		...
		UVs[0] = new Vector2(BlockDataManager.tileSizeX * (tilePos.x + 1) -
			BlockDataManager.textureOffset,
				BlockDataManager.tileSizeY * tilePos.y + BlockDataManager.textureOffset);
	
		UVs[1] = new Vector2(BlockDataManager.tileSizeX * (tilePos.x + 1) -
			BlockDataManager.textureOffset,
				BlockDataManager.tileSizeY * (tilePos.y + 1) - BlockDataManager.textureOffset);
