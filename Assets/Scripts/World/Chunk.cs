	...
	public static void setBlock(ChunkData chunkData, Vector3Int localPosition, BlockType block)
	{
		...
		else
		{
			if (block == BlockType.Stone)
				throw new Exception("Need to ask world for appropriate chunk Stone problem"); //Change later
			else
				throw new Exception("Need to ask world for appropriate chunk NotStone problem"); //Change later
		}
	}
