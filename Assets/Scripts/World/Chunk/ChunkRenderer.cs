...
public class ChunkRenderer : NetworkBehaviour
{
	...
	Mesh mesh;
	public bool showChunkSize = false;
	...
	public void initChunk(ChunkData data)
	{
		this.ChunkData = data;
	}
	...
	private void OnDrawGizmos()
	{
		if (showChunkSize)
		{
			if (Application.isPlaying && ChunkData != null)
			{
				...
				Gizmos.DrawCube(transform.position + new Vector3(ChunkData.chunkSize / 2f,
				ChunkData.chunkHeight / 2f, ChunkData.chunkSize / 2f), new Vector3(ChunkData.chunkSize, ChunkData.chunkHeight,
				ChunkData.chunkSize));
			}
		}
	}
